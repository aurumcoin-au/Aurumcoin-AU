...
This document provides guidelines for internationalization of the Aurumcoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Aurumcoin network</source>
        <translation>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aurumcoin_en.ts` remains unchanged.
