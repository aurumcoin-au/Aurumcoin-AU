...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CAurumcoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CAurumcoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CAurumcoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CAurumcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CAurumcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAurumcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
