...
#ifndef AURUMCOIN_TEST_SCRIPTNUM10_H
#define AURUMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Aurumcoin Core 0.10.0, for cross-comparison.
 */
public:
