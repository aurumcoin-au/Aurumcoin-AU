...
#ifndef AURUMCOIN_QT_AURUMCOINUNITS_H
#define AURUMCOIN_QT_AURUMCOINUNITS_H
...
/** Aurumcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AurumcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AurumcoinUnits(QObject *parent);

    /** Aurumcoin units.
      @note Source: https://en.aurumcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        AU,
...
typedef AurumcoinUnits::Unit AurumcoinUnit;

#endif // AURUMCOIN_QT_AURUMCOINUNITS_H
