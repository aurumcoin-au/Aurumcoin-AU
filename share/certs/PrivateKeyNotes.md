...
unlocked to sign the Aurumcoin-Qt.app bundle.
...
allowing somebody to distribute a Aurumcoin-Qt.app or aurumcoin-qt-setup.exe with a valid
...
that the aurumcoin-qt.exe file inside the installer had not been tampered with.
